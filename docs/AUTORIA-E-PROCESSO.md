...
- orientar terminologia e critérios de preservação;
- conduzir testes no cliente e identificar problemas no uso real;
- aprovar resultados e decidir quando uma versão pode ser publicada;
- manter o projeto e responder pelas entregas.
